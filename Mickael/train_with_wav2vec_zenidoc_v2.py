...
if __name__ == "__main__":
    ...
    tokenizer = SentencePiece(
        ...
        user_defined_symbols="aa,adam,ae,aen,ai,aï,ail,aim,aim_,ain,am,an,aon,aou,août,au,aw,ay,aye,bb,ca,cc,cca,cce,cch,cci,cco,ccu,ccueil,ccy,ce,ch,ci,co,cqu,ct,cu,cueil,cy,dd,ds,ea,ean,eau,ect,ed,ee,ée,ef,ei,eil,eim,ein,em,emmm,en,enn,ent,er,es,eu,eû,ew,ez,ff,ga,ge,geu,geü,gg,gge,ggi,gh,gi,gn,go,gt,gu,gua,gue,guë,güe,gui,ign,iil,il,ill,illaire,ille,illier,im,imm,imma,imme,immi,immo,immu,in,ing,jean,jeun,ll,lle,mm,mn,nn,oa,oe,oi,oil,om,on,ou,ph,pp,ps,pt,qu,qua,qui,rh,rr,rrh,sc,sca,sce,sch,sci,sco,scu,scy,ss,th,tia,tie,tiel,tien,tient,tieuse,tieux,tion,tt,tz,uil,um,un,uy,ym,yn",
    )
